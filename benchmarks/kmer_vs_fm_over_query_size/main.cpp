...
template<size_t k>
void register_benchmark(size_t text_length, size_t min_query_length, size_t max_query_length)
{
...
void register_all()
{
    (register_benchmark<ks>(text_length, ks - 2, 6*ks), ...);
...
int main(int argc, char** argv)
{
     ...
     */
    cleanup_csv("/home/clem/Documents/Workspace/kmer_index/source/benchmarks/raw.csv");
}
