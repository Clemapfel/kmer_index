...
single_only = single_only + scale_x_continuous(name="query length", breaks=c(seq(1, 10, 1), seq(12, 50, 2))) + scale_y_continuous(name="runtime (ns)", seq(0, 6e07, 1e07))
single_only = single_only + theme(legend.title=element_blank(), legend.position="none", plot.title=element_text(face="bold", size=30), plot.subtitle=element_text(size=20), axis.title=element_text(size=20), axis.text=element_text(size=12))
...
multi_vs_single = multi_vs_single + theme(plot.title=element_text(face="bold", size=30), legend.title=element_blank(), legend.position="bottom", legend.text=element_text(size=20), axis.title=element_text(size=20), axis.text=element_text(size=12))
...
multi_vs_fm = multi_vs_fm + theme(plot.title=element_text(face="bold", size=30), plot.subtitle = element_text(size=12), legend.title=element_blank(), legend.text=element_text(size=20), axis.title=element_text(size=20), axis.text=element_text(size=12))
