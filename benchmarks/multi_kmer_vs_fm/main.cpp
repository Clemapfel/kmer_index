...
void register_all()
{
    ...
    auto multi_kmer = kmer::make_kmer_index<10, 11, 13, 15, 17, 19, 21, 23, 25, 27>(text, std::thread::hardware_concurrency());
    ...
    {
        benchmark::RegisterBenchmark("multi_kmer", &multi_kmer_search<seqan3::dna4, 10, 11, 13, 15, 17, 19, 20, 21, 23, 25, 27>, query_length, multi_kmer);
