...
data <- read.csv("2020-06-17_19-19-25.csv")
...
plot = plot + theme(plot.title=element_text(face="bold")) + xlim(c(20, 200))
...
plot = plot + scale_x_continuous(breaks=seq(0, 200, 10)) + ylim(c(500, 1500))
